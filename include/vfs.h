    ...
    vfile_t * vfile_open(vfs_t * fs,const char* path,const char * filename,vfile_open_modes mode);
    ...
    int vfs_remove(vfs_t * fs,const char * path,const char* file_name);
    ...
    int vfs_remove_dir(vfs_t * fs,const char * dir_Path);
